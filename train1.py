...
if __name__ == '__main__':
    ...
    optimizer = optim.Adam(optim_configs, lr=1e-4, weight_decay=1e-4)#  
    # optimizer = adabound.AdaBound(optim_configs, lr=5e-5, final_lr=5e-5)
    ...
    # text_logger=VisdomTextLogger(update_type='REPLACE',)
